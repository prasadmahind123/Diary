...
function Login() {
    ...
    return (
        // Added animation style to the root div
        <div 
                ...
                <div className="mx-auto w-full max-w-sm lg:w-96">
                    <div className="mb-8">
                        ...
                        <p className="mt-2 text-sm text-gray-600">
                            Please enter your details to access your diary.
                        </p>
                    </div>
                    ...
                    <p className="mt-8 text-center text-sm text-gray-500">
                        ...
                        {/* Swapped <a> for <Link> for SPA navigation */}
            ...
            <div className="hidden h-screen w-1/2 bg-gray-100 lg:block">
                <div className="relative h-full w-full">
                    <img
                        ...
                        src="https://images.unsplash.com/photo-1455390582262-044cdead277a?q=80&w=2500&auto=format&fit=crop"
